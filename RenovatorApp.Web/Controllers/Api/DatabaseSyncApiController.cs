...
public sealed class DatabaseSyncApiController : ControllerBase
{
    ...
    public async Task<ActionResult<DatabaseSyncResponse>> GetDatabase(CancellationToken cancellationToken)
    {
        ...
        return new DatabaseSyncResponse(DateTime.UtcNow, addresses, buildings, buildingTypes, customers, calendarEvents, customerProperties, properties, parts, partSources, inspectionAreaCategories, inspectionAreaTypes);
    }
